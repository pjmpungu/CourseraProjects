...
public class GalleryActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            // TODO - you fill in here.
            setItems(extractInputUrlsFromIntent(getIntent()));
        }
    ...
    private boolean validateInput(ArrayList<Uri> inputUrls) {
        ...
        if(inputUrls==null){
            ...
            for (Uri element: inputUrls) {
                if (!UriUtils.isValidUrl(element.toString())) {
                    return false;
                }
            }
        }
     ...
     */
    protected void createAndReturnResultsIntent(@NonNull ArrayList<Uri> urls) {
